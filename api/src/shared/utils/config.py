...
class GeneralConfig(BaseModel):
    ...
    API_LOG_LEVEL: str = check_log_level(act_log_level=os.getenv('API_LOG_LEVEL', default='info'))
    API_STORAGE_PATH: str = f"{os.getcwd()}/{os.getenv('API_STORAGE_PATH', default='src/storage/')}"
